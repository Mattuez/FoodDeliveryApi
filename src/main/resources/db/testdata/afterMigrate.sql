...
VALUES (1, null, 'Tambauzinho', 'Av. Pres. Epitácio Pessoa', '2458', '58045-000', 10.00, 'China on plate', 1, 3,
       ...
       (2, null, 'Manaira', 'Av. Gov. Flávio Ribeiro Coutinho', '1153', '58038-300', 8.50, 'Boi na brasa', 1, 1,
       ...
       (4, null, 'Cabo Branco', 'Av. Cabo Branco', '3560', '58045-902', 12.00, 'Sushi Time', 1, 6, utc_timestamp,
       ...
       (14, null, 'Cidade Baixa', 'Rua General Lima e Silva', '901', '90050-100', 12.50, 'Galeteria Mama Mia', 3, 7,
        utc_timestamp, utc_timestamp, true, true, false),
       (15, 'No BarraShoppingSul', 'Cristal', 'Av. Diário de Notícias', '300', '91750-420', 18.00, 'Koh Pee Pee', 3, 10,
       ...
       (21, 'Em Ipanema', 'Ipanema', 'Rua Garcia D''Ávila', '128', '22420-010', 18.00, 'Zuka', 5, 1, utc_timestamp,
        utc_timestamp, true, false, false),
       ...
       (23, 'Em Pinheiros', 'Pinheiros', 'Rua dos Pinheiros', '1293', '05422-002', 16.50, 'Mocotó', 6, 1, utc_timestamp,
        utc_timestamp, true, true, false),
       (24, 'Em Moema', 'Moema', 'Av. Ibirapuera', '2927', '04029-200', 19.00, 'Aoyama - Moema', 6, 6, utc_timestamp,
        utc_timestamp, true, false, false),
